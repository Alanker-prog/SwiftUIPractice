...
struct InterestPillGreedView: View {
...
#Preview {
    VStack {
        InterestPillGreedView(interests: User.mock.interests)
        InterestPillGreedView(interests: User.mock.basics)
    }
